...
When ran the template will ask us a few questions. The first is the name of the existing role name. Enter the name of the role you want to add the Molecule structure. <mark>The name must match the folder name of the existing role. In our example case that is existing_windows_role
